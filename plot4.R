...
#plot #2
with(smallset, plot( smallset$DateTime, smallset$Voltage, ylab="Voltage", xlab="datetime", type="l"))
#plot #3
...
#plot #4
with(smallset, plot( smallset$DateTime, smallset$Global_reactive_power, xlab="datetime",  ylab = "Global Reactive Power", type="l"))
#graphics device off
dev.off()